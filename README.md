...
![Distributions of forgetting counts](https://github.com/mtoneva/forgetting_temp/blob/master/figures/Fig1.png?raw=true "Distributions of forgetting counts" | width=100)
